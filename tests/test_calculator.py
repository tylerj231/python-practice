...
class TestHappyPass:
    ...
    def test_addition_negative_value(self, calculator):
        a = -5
        b = 5
        expected = 0
    ...
    def test_subtraction_negative_value(self, calculator):
        a = -5
        b = 5
        expected = -10
    ...
    def test_multiplication_negative_value(self, calculator):
        a = -5
        b = 5
        expected = -25
    ...
    def test_division_negative_value(self, calculator):
        a = -5
        b = 5
        expected = -1
...
class TestNegativePath:
    ...
    def test_addition_invalid_value(self, calculator):
        valid_param = 1
    ...
    def test_subtraction_invalid_value(self, calculator):
        valid_param = 10
        invalid_param = "Invalid"
    ...
    def test_multiplication_invalid_value(self, calculator):
        valid_param = 12
        invalid_param = None
    ...
    def test_division_invalid_value(self, calculator):
        valid_param = 5
        invalid_param = "Invalid"
